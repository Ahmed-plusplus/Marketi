                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Assets.images.illustrationVerificationCodeWithEmail.image(width: 300, height: 256),
                      Padding(
                        padding: const EdgeInsets.all(22.0),
                        child: Text('${AppStrings.forgetPasswordBody3}${widget.email}', maxLines: 2, textAlign: TextAlign.center,),
                      ),
                      VerificationCode(
                      ...
                      BlocConsumer<AuthCubit, AuthStates>(
                          listener: (context, state){
                            if(state is VerifyCodeSuccessfulStates){
                              customReplacementNavigate(context, RoutesName.changePassword, extra: widget.email);
                          ...
                          builder: (context, state) {
                            ...
                            return CustomElevatedButton(
                                ...
                                onPressed: () {
                                  if(code != null) {
                                    _cubit.verifyCode(widget.email, code!);
                                  } else {
                      ...
                      const SizedBox(height: 22,),
                      GestureDetector(
                        onTap: () => _cubit.resendCode(widget.email),
